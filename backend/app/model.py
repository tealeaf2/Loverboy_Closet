...
class Product(db.Model):
    ...
    masterCategory = db.Column(db.String(255), nullable=False)
    subCategory = db.Column(db.String(255), nullable=False)
    articleType = db.Column(db.String(255), nullable=False)
    baseColour = db.Column(db.String(255), nullable=False)
    year = db.Column(db.Integer, nullable=False)
    usage = db.Column(db.String(255), nullable=False)
    productDisplayName = db.Column(db.String(255), nullable=False)
...
class Shirt(db.Model):
    ...
    Material = db.Column(db.String(255), default=None)
